...
//		}
        ...
        $checkCaptcha = $this->input->post('captcha') == $this->session->userdata('captcha');
        if ($checkCaptcha && $this->form_validation->run() == true && $this->ion_auth->register($username, $password, $email, $additional_data)) {
